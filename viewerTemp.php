...
$fil = 'log-kvv32_heater_temp-'.$parameter.'-5C-CF-7F-23-A3-2A-'.$select.'.saxeniot';

echo("$fil $select<br>");
echo("<h2>Temperatures KVV2</h2>");
echo ("<a href=\"viewerTemp.php?date=sum\">Summary</a><br>");
exec("ls sum*heater_temp-".$parameter."*.saxeniot > work.txt");
$lines = file('work.txt');
$count = 0;
...
<head>
  <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    ...
    ?>
      ...
      var options = {
        chart: {
          title: 'Daily Temperatures KVV32',
          subtitle: 'in Celcius'
        },
        width: 1600,
        height: 900,
...
<body>
<form action="viewerTemp.php" method="post">
